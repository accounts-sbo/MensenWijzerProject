        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-6 text-base leading-relaxed text-gray-700">
              ...
              <div className="space-y-4">
                ...
                <ul className="space-y-3 ml-6">
                  <li className="flex items-start">
                    ...
                    <span>Je eigen woorden kiest in plaats van "mooie" woorden</span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-mensen-blue mr-3 mt-1">•</span>
                    <span>Imperfecties inzet als menselijkheid</span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-mensen-blue mr-3 mt-1">•</span>
                    <span>Je verhaal koppelt aan je missie</span>
                  </li>
                </ul>
            ...
            <div className="my-12">
              ...
              <div className="space-y-4">
                <p>
                  Invloedrijke sprekers richten zich niet op overtuigen, maar op verbinden. Ze stellen zichzelf de vraag: <em>Hoe kan mijn identiteit iets betekenen voor deze groep, op dit moment?</em>
                </p>
