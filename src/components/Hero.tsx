...
const Hero = () => {
  return <section className="relative h-screen w-full bg-mensen-beige overflow-hidden">
      ...
      <div className="absolute bottom-0 right-0 w-1/2 h-full z-10 flex justify-end items-end opacity-30">
        <img src="/lovable-uploads/1fc0168d-3969-4dbc-927e-e2c58fc3e28e.png" alt="De Mensen Wijzer Logo" className="w-full h-auto object-contain object-bottom" />
      </div>
      ...
      <div className="absolute bottom-8 left-0 right-0 z-30 flex justify-center items-center">
        <a href="#about" className="text-white opacity-80 hover:opacity-100 transition-opacity flex flex-col items-center" aria-label="Scroll naar beneden">
